...
//        String phone = "13343915002"; // 此处可输入你的手机号码进行测试
...
//  }
    ...
    public  static String getPhonemsg(String mobile,String code) {
        ...
        if (mobile == null &&mobile.length() != 11 ) {
            System.out.println("手机号为空或手机号长度不对");
            return "";
        }
        /**
         * 短信验证---阿里大于工具
       ...
       // request.setTemplateParam("{\"code\":\"" + code + "\",\"name\":\"" + name + "\",\"username\":\"" + username + "\", \"date\":\"" + date + "\"}");
    ...
    public static String vcode() {
        ...
        re.getSession().setAttribute("vcode",vcode);
        re.getSession().setMaxInactiveInterval(60);
        System.out.println(vcode+"验证码0");
        return vcode;
    }
